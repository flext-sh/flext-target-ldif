    ...
    class TargetLdif:
        ...
        class ConfigValidation:
            ...
            def validate_ldif_target_config(
                ...
                file_validation = FlextTargetLdifUtilities.TargetLdif.FileUtilities.validate_ldif_file_path(
                    output_file,
                )
        ...
        class StateManagement:
            ...
            def set_target_state(
                ...
                if isinstance(bookmarks_raw, Mapping):
                    bookmarks = {
                        str(key): value for key, value in bookmarks_raw.items()
                    }
            ...
            def update_processing_progress(
                ...
                """
                stream_state = FlextTargetLdifUtilities.TargetLdif.StateManagement.get_target_state(
                    state,
                    stream_name,
                )
                ...
                return FlextTargetLdifUtilities.TargetLdif.StateManagement.set_target_state(
                    state,
                    stream_name,
