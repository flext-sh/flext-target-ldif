# Triagem Semgrep — flext-sh/flext-target-ldif

Gerado do dump da plataforma Semgrep (deployment `datacosmos`, 2026-08-06).

Bead de rastreio: `mro-p57t.27`
...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 618 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-target-ldif.json`
