...
```yaml
        1  # Generated by `flext-infra codegen conform` for flext-target-ldif — DO NOT EDIT.
        2  version: 2
        3  updates:
...
**Classe**: Insecure Configuration · **Local**: `pyproject.toml:618`
...
```toml
      614  all = true
      615  in_place = true
      616  sort_first = ["build-system", "dependency-groups", "project", "tool"]
      617  
>>>   618  [tool.uv]
      619  link-mode = "copy"
      620  
      621  [tool.vulture]
      622  exclude = ["*/_protocols/*"]
```
